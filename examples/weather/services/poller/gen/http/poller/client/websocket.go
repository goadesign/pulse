...
// RecvWithContext reads instances of "poller.Forecast" from the "subscribe"
// endpoint websocket connection with context.
func (s *SubscribeClientStream) RecvWithContext(ctx context.Context) (*poller.Forecast, error) {
	return s.Recv()
}
