...
func DecodeAddLocationRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*poller.CityAndState, error) {
	return func(r *http.Request) (*poller.CityAndState, error) {
		var payload *poller.CityAndState
		var (
			city  string
			state string
			err   error
...
// subscribe endpoint.
func DecodeSubscribeRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*poller.CityAndState, error) {
	return func(r *http.Request) (*poller.CityAndState, error) {
		var payload *poller.CityAndState
		var (
			city  string
