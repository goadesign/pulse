...
// SendWithContext streams instances of "poller.Forecast" to the "subscribe"
// endpoint websocket connection with context.
func (s *SubscribeServerStream) SendWithContext(ctx context.Context, v *poller.Forecast) error {
	return s.Send(v)
}
